...
<body>
	...
	<form:form action="${pageContext.servletContext.contextPath }/themSP" method="post" modelAttribute="sanpham"  enctype="multipart/form-data">
	<table>
		<tr>
			<td>Tên sản phẩm:</td>
		...
		<tr>
			...
			<td ><input type="reset" value="Xóa trắng"> </td>
		</tr>
	...
	<div>${message }</div>
	<a href="${pageContext.servletContext.contextPath }/qlsanpham">Quay lại trang quản lý</a>
</body>
</html>